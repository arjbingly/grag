...
def test_embeddings(embedding_config):
    ...
    doc_sets = [('The new movie is awesome.', 'The new movie is so great.', 'The video is awful'),
                ('The cat sits outside.', 'The dog plays in the garden.', 'The car is parked inside')]
