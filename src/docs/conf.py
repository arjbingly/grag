...
sphinx_gallery_conf = {
    'examples_dirs': ['../../cookbook/Basic-RAG', '../../cookbook/RAG-GUI', '../../cookbook/Retriver-GUI'],  # path to your example scripts
    # 'examples_dirs': '../../cookbook',
    'gallery_dirs': ['auto_examples/Basic-RAG', '../../cookbook/RAG-GUI', 'auto_examples/Retriver-GUI'],
